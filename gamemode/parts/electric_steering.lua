Part.Name = "Electric Power Steering";
...
// Sterring Details
Part.AddedTurningDegrees_Slow = 5; // steering cone at zero to slow speed
Part.AddedTurningDegrees_Fast = 2.5; // steering cone at fast speed to max speed
Part.AddedTurningDegrees_Boost = 2.5; // steering cone at max boost speed (blend toward this after max speed)
