Part.Name = "Supercharger";
Part.Class = "Engine Supercharging";
Part.ClassLevel = 1;
Part.Cost = 2500;
Part.Icon = "supercharger";
Part.Description = "Increases maximum turbo speed by 10 MPH.";
Part.Sellable = true;
Part.RequiredModels = {}
...
Part.AddedBoostMaximumSpeed = 10; // Increases the maximum speed of the nos. In MPH. Default max speed is maxmph * 1.5
