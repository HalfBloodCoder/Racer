Part.Name = "Anti-Lock Braking System";
...
Part.AddedAutobrakeMaximumSpeed = .1; // Default is 1.1, the maximum speed the car can go in multiple of mph while rolling
...
// Braking Details
Part.AddedForwardAxilBreaking = .1; // Default is .4
