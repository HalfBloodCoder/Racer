Part.Name = "Sequential Twin Superchargers";
Part.Class = "Engine Supercharging";
Part.ClassLevel = 3;
Part.Cost = 15000;
Part.Icon = "supercharger";
Part.Description = "Increases maximum turbo speed by 5 MPH.";
Part.Sellable = true;
Part.RequiredModels = {}
...
Part.AddedBoostMaximumSpeed = 25; // Increases the maximum speed of the nos. In MPH. Default max speed is maxmph * 1.5
