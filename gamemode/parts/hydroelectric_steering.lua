Part.Name = "Electro-Hydraulic Power Steering";
...
// Engine Details
Part.AddedWeight = 100; // Weight of the part.
...
// Sterring Details
Part.AddedTurningDegrees_Slow = 15; // steering cone at zero to slow speed
Part.AddedTurningDegrees_Fast = 8; // steering cone at fast speed to max speed
Part.AddedTurningDegrees_Boost = 8; // steering cone at max boost speed (blend toward this after max speed)
