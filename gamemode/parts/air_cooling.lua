Part.Name = "Air Cooling System";
Part.Class = "Cooling System";
Part.ClassLevel = 1;
Part.Cost = 5000;
Part.Icon = "radiator";
Part.Description = "Decreases cooldown of turbo by 2 seconds.";
Part.Sellable = true;
Part.RequiredModels = {}
Part.RequiresAccess = 0;

// Engine Details
Part.AddedWeight = 35; // Weight of the part.
...
Part.AddedBoostDelay = -2; // Delay between each nos, should always use - unless it's something that'll slow the car down
