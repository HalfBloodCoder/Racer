Part.Name = "Wet Single-Point Nitrous System";
Part.Class = "Nitrous System";
Part.ClassLevel = 2;
Part.Cost = 10000;
Part.Icon = "nitrous";
Part.Description = "Increases boost of turbo by 10%.";
Part.Sellable = true;
Part.RequiredModels = {}
Part.RequiresAccess = 0;

// Engine Details
Part.AddedWeight = 125; // Weight of the part.
...
// Nos Details
Part.AddedBoostForce = .15; // nos added force, in %.    .1 = 10%
