Part.Name = "Wet Direct Port Nitrous System";
Part.Class = "Nitrous System";
Part.ClassLevel = 3;
Part.Cost = 15000;
Part.Icon = "nitrous";
Part.Description = "Increases boost of turbo by 5%.";
Part.Sellable = true;
Part.RequiredModels = {}
Part.RequiresAccess = 0;

// Engine Details
Part.AddedWeight = 150; // Weight of the part.
...
// Nos Details
Part.AddedBoostForce = .2; // nos added force, in %.    .1 = 10%
