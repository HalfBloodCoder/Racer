Part.Name = "Emergency Braking System";
Part.Class = "Braking System";
Part.ClassLevel = 2;
Part.Cost = 15000;
Part.Icon = "ebs";
Part.Description = "Increase braking power and roll speed.";
Part.Sellable = true;
Part.RequiredModels = {}
...
Part.AddedAutobrakeMaximumSpeed = .4; // Default is 1.1, the maximum speed the car can go in multiple of mph while rolling
...
// Braking Details
Part.AddedForwardAxilBreaking = .2; // Default is .4
Part.AddedRearAxilBreaking = .2; // Default is .7;
