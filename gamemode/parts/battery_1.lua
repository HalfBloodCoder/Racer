Part.Name = "Basic Air Intake";
Part.Class = "Performance Enhancement";
Part.ClassLevel = 1;
Part.Cost = 5000;
Part.Icon = "air_intake";
Part.Description = "Increase horsepower by 150.";
Part.Sellable = true;
Part.RequiredModels = {}
...
Part.AddedHorsepower = 150; // Acceleration
