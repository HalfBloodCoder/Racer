Part.Name = "12 Cylinder Haul Ass VIP Engine";
Part.Class = "Engine";
Part.ClassLevel = 5;
Part.Cost = 100000;
Part.Icon = "10_cylinder";
Part.Description = "Increases maximum speed by 10 MPH and Horsepower by 100.";
Part.Sellable = true;
...
Part.AddedHorsepower = 100; // Acceleration
Part.AddedForwardMaximumMPH = 40; // Maximum forward MPH
Part.AddedReverseMaximumMPH = 25; // Maximum reverse MPH
